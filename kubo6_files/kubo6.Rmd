...
```{r}
d <- read.csv("/Users/hamaokigaizaburo/Documents/kuboR/intro-statistical-modeling-master/data/data6a.csv")
summary(d)
...
```{r fig.show="hold", out.width="50%", out.height="100%", fig.align="default"}
d <- read.csv("/Users/hamaokigaizaburo/Documents/kuboR/intro-statistical-modeling-master/data/data6b.csv")
...
```{r}
d <- read.csv("/Users/hamaokigaizaburo/Documents/kuboR/intro-statistical-modeling-master/data/data6c.csv")
